...
class ServiceOrderWizard(models.TransientModel):
    _name = 'zdg_dashboard.service.order.wizard'
    _description = 'Report Service Order'
    ...
    def _print_report(self, data):
        ...
        return self.env.ref('zdg_dashboard.report_service_order').report_action(records, data)
