...
class ReportFinancialXlsx(models.AbstractModel):
    _name = 'report.zdg_account_report.report_financial_xlsx'
        ...
        for report in child_reports:
            ...
            if res[report.id].get('account'):
                ...
                for account_id, value in res[report.id]['account'].items():
                    ...
                    # user_type = self.env['account.account.type'].browse(account.user_type_id.id)
                    vals = {
                        'user_type': account.user_type_id.display_name,
