...
class ReportCsoWizard(models.TransientModel):
    _name = 'service.report.cso.wizard'
    _description = 'Report CSO'
    ...
    def _print_report(self, data):
        ...
        return self.env.ref('service.report_cso').report_action(records, data)
