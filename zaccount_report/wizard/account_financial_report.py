...
#         return self.env['report'].get_action(self, 'zaccount_report.report_financial', data=data)
        return self.env.ref('zaccount_report.action_report_financial').report_action(self, data=data)
